...
public class US_013_US_022 extends OptionsMet {
    ...
    @Given("User verifies {string} category is enable and clickable")
    public void user_verifies_category_is_enable_and_clickable(String string) {
    ...
    @Given("User verifies that the products of the Harrods brand were selected")
    public void user_verifies_that_the_products_of_the_harrods_brand_were_selected() {
    ...
    @Given("Success message is visible")
